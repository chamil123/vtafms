...
<html>
    ...
    <script>
        ...
        var loadData = function () {
            ...
            $.ajax({
                type: 'POST',
                url: "../../GetCenterValuesBetweenDates?fromdate=" + fromdate + "&todate=" + todate + "&cname=" + cname+"&type=centerReport"
            }).done(function (data) {
                var rowTokens = data.split("!");
                var x;
                for (x = 0; x < rowTokens.length - 1; x++) {
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <form  role="form"  action="../../AddReport?value=centerReport" method="POST" >
                        <div class="box box-default">
                            <div class="box-header">
                                ...
                                <div class="col-md-2">
                                    <button type="submit"  class="btn btn-info" style="margin-left: 0px" onclick="getdate()">
