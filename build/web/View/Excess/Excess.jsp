    ...
    <head>
        ...
        <script>
            ...
            function addRow(tableID) {
                ...
                duePayment.type = "text";
                if (rowCount % 2 == 1) {
                    reson.style = "border-style: hidden;background-color : #EEEEEE;width : 265px;";
                } else {
                    reson.style = "border-style: hidden;width : 265px;";
                }
                                ...
                                <form method="POST" action="../../AddExcess">
                                    <div class="col-md-12">
                                        <div class="form-group" style="width: 400px">
                                            ...
                                            <input type="text" name="cname" style="color: black" id="cname" class="form-control" placeholder="Select Center">
                                        </div>
                                        <div class="form-group" style="width: 400px">
                                            <label>Center name</label>
                                            <input type="text" name="cnumber" style="color: black" id="cnumber" class="form-control" readonly placeholder="Center number">
                                        </div>
                                        <div class="form-group" style="width: 400px">
                                            <label>date</label>
                                            <input type="date" id="edate" name="edate" class="form-control"placeholder="Enter date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 " >
                                        ...
                                        <div> <input type="text" id="tot" name="tot"style="font-size: 16px;width: 200px;float: right"  class="form-control" ></div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary"  value="Add Excess" name="Add">
