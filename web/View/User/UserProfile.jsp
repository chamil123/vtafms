...
<%@page import="BIT.Project.VTAFMS.Controller.LoginController"%>
<%@page import="BIT.Project.VTAFMS.Model.Login"%>
...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
      ...
      System.out.println("usaer id Lllllllllllllllll : "+userid);
      User user=UserController.searchUserById(Integer.parseInt(userid.toString()));
      Login login=LoginController.searchUserById(user.getUser_id());
      %>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="password" class="form-control my-colorpicker1" id="pwd" name="pwd" value="<%=login.getLogin_password()%>" placeholder="Enter username">
                                            </div>
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label>Address:</label>
                                                <textarea class="form-control" rows="4" id="address" name="address" value="" placeholder="Enter Address"><%=user.getUser_address()%></textarea>
                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  type="file" id="img" name="img" class="form-control"  style="border: #ffffff;padding-left: 0px" value="">
