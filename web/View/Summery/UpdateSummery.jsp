...
<%@page import="BIT.Project.VTAFMS.Controller.SummeryLineController"%>
<%@page import="BIT.Project.VTAFMS.Model.SummeryLine"%>
...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini" onload="selectedItem();">
        ...
        <%
            ...
            Summery summery = SummeryController.searchSummeryById(Integer.parseInt(summery_id));

            String center_id = summery.getCenter_id();
            ...
            CenterCash centercash = CenterCashController.searchCenterCashByDateandId(summery.getSummery_date(), summery.getCenter_id());
            ...
            List<SummeryLine> summery_line = (List<SummeryLine>) SummeryLineController.getAllSummeryLineBysummeryID(Integer.parseInt(summery_id));
            ...
            <div class="content-wrapper">
                ...
                <script>
                    ...
                    function rowTot() {
                        ...
                        var total = 0;
                        var row = rowCount - 2
                        var currentTot = document.getElementById('payment').value;
                        ...
                        if (row > 0) {
                            ...
                            document.getElementById('paymentTotal').value = total + q;
                        } else {
                            var payment = document.getElementById('payment').value;
                            ...
                            <div class="col-md-8">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        ...
                                        <div  id="date" name="date" style="float: right;font-size: 16px;color: #ffffff"></div>
                                        <input type="text" id="dates" name="dates" value="<%=summery.getSummery_date()%>" style="float: right;font-size: 16px;border: hidden"/>
                                    </div>
                                    <div class="box-body" style="padding-bottom: 70px">
                                        ...
                                        <div class="col-md-6" style="padding-left: 0px; padding-right: 0px">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden"   value="<%=summery_id%>" id="summery_id" name="summery_id">
                                                    <input type="text" class="form-control" readonly value="<%=summery.getSummery_name()%>" id="cname" name="cname" placeholder="Enter center name">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden"  id="lcrate" value="<%=center.getCenter_lc()%>" name="lcrate" >
                                                    <input type="hidden"  id="ncrate" value="<%=center.getCenter_nc()%>" name="ncrate" >
                                                    <input type="text" class="form-control my-colorpicker1" id="lamount" value="<%=summery.getSummery_lessCommisionAmount()%>" name="lamount" onkeyup="totlcnc();" placeholder="Enter center name">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6" style=" padding-right: 0px">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control my-colorpicker1" value="<%=center.getCenter_com()%>" id="com" name="com" disabled>
                                                    <input type="text" class="form-control my-colorpicker1" readonly value="<%=summery.getCenter_id()%>" id="cnumber" name="cnumber" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control my-colorpicker1" id="namount" value="<%=summery.getSummery_noCommisionAmount()%>" name="namount" onkeyup="totlcnc();" placeholder="Enter center name">
                                                </div>
                                            </div> 
                                        </div>
                                        ...
                                        <div class="col-md-12" style="padding:15px 15px 15px 15px;background-color: #f0f0f0">
                                            ...
                                            <table id="addressesTable"  class="table-style-three"   width='100%' style="padding: 10px 10px 10px 10px" >
                                                ...
                                                <%
                                                    int i = 1;
                                                    for (SummeryLine model : summery_line) {

                                                %>
                                                <tr>
                                                    <td><input type="checkbox" name="chk"/></td>

                                                    <td>&nbsp;<input type="text" style="border-style: hidden;background-color: #EEEEEE" value="<%=model.getSummery_line_chitNumber()%>" name="houseNum[<%=i%>]" /></td>
                                                    <td>&nbsp;<input type="text" style="border-style: hidden;background-color: #EEEEEE" value="<%=model.getSummery_line_Investment()%>" name="city[<%=i%>]" /></td>
                                                    <td>&nbsp;<input type="text" style="border-style: hidden;background-color: #EEEEEE" value="<%=model.getSummery_line_payment()%>" name="country[<%=i%>]"   /></td>
                                        ...
                                        <div class="col-md-12 " style="height: 200px">
                                            ...
                                            <table>
                                                <tr style="border-top: 1px solid">
                                                    ...
                                                    <td > <input type="text" style="font-size:  20px;border:none;width: 170px" readonly  id="fc" name="fc" value="<%=centercash.getCenterCash_details_FullCollection()%>"/></td>
                                                    <td style="width: 170px"><label >Payment Total</label></td>
                                                    <td ><input type="text" style="font-size:  27px;border:none;width: 120px;font-weight: bold;color: #0000ff;text-align: right" readonly  id="paymentTotal" name="paymentTotal" value="<%=summery.getSummery_slippaytot()%>"/></td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 200px"><label>LC & NC amount :</label></td>
                                                    <td ><input type="text" style="font-size:  20px;border:none;width: 170px" readonly  id="lcnc" name="lcnc" value="<%=summery.getSummery_lcnc()%>"/></td>
                                                    <td style="width: 170px"><label >commision value</label></td>
                                                    <td ><input type="text" style="font-size:  20px;border:none;width: 120px;text-align: right" readonly  id="paycoms" name="paycoms" value="<%=summery.getSummery_compay()%>"/></td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 200px"><label>Paper cash :</label></td >
                                                    <td ><input type="text" style="font-size:  20px;border:none;width: 170px" readonly  id="papercash" name="papercash" value="<%=summery.getSummery_papercash()%>"/></td> 
                                                    <td style="width: 150px"><label>Expenses :</label></td>
                                                    <td ><input type="text" style="font-size:  20px;border:none;width: 120px;text-align: right" readonly  id="exp" name="exp" value="<%=summery.getSummery_expences()%>"/></td>
                                                </tr><tr>
                                                    <td style="width: 200px"><label>Loan:</label></td>
                                                    <td ><input type="text" style="font-size:  20px;border:none;width: 170px" readonly  id="loan" name="loan" value="<%=summery.getSummery_loan()%>"/></td> 
                                                    <td style="width: 150px"><label>Excess :</label></td>
                                                    <td ><input type="text" style="font-size:  20px;border:none;width: 120px;text-align: right" readonly  id="exc" name="exc" value="<%=summery.getSummery_excess()%>"/></td>
                                                </tr>

                                                <tr>
                                                    <td style="width: 200px"><label>Passed due:</label></td>
                                                    <td ><input type="text" style="font-size:  20px;border:none;width: 170px" readonly  id="pd" name="pd"  value="<%=centercash.getCenterCash_details_passDue()%>"/></td> 
                                                    <td style="width: 150px"><label>Cash :</label></td>
                                                    <td ><input type="text" style="font-size:  20px;border:none;width: 120px;text-align: right" readonly  id="cash" name="cash" value="<%=centercash.getCenterCash_details_cash()%>" /></td>
                                                </tr>

                                                <tr style="border-top: 1px solid">
                                                    <td style="width: 200px"><label>due sub total:</label></td>
                                                    <td ><input type="text" style="font-size:  20px;font-weight: bold;border:none;width: 170px" readonly  id="duesub" name="duesub"  value="0"/></td> 
                                                    <td style="width: 150px"><label>pay sub total :</label></td>
                                                    <td ><input type="text" style="width: 120px;font-size:  20px;font-weight: bold;border: none;text-align: right;" readonly  id="paysub" name="paysub" value="0"/></td>
                                                </tr>
                                                <tr  style="border-top: 1px solid;">
                                                    <td colspan="2" ></td>
                                                    <td  style="width: 150px;font-size:  25px;border-bottom: 2px solid"><label>Balance :</label></td>
                                                    <td style="border-bottom: 2px solid;"><input type="text" style="width: 120px;font-size:  35px;font-weight: bold;border: none;text-align: right;" readonly  id="balance" name="balance" value="<%=summery.getSummery_lcnc()%>"/></td>
                                                </tr >
                                            </table>
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-info" onclick="doajax();" value="Update summery" name="Update"/>
