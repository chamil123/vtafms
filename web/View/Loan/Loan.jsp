...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini" onload="selectedItem();">
        ...
        <%
            String cash = request.getParameter("res_loan");
            int res_cash = 0;
            if (cash != null) {
                                ...
                                <div class="box box-default">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control my-colorpicker1 required" id="rate" value="0.0" name="rate" placeholder="Enter rate">
                                            <span id="msgcname"  style="color: #ff0000"></span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Remark :</label>
                                            <textarea class="form-control required" rows="3" id="remark" id="remark" name="remark" placeholder="Enter remark"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="submit" class="btn btn-primary" value="Add loan" name="Add"/>
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control my-colorpicker1 required" id="date" name="date" placeholder="yyyy-mm-dd">
                                        </div>
                                        <div class="form-group">
                                            <label>Loan Amount :</label>
                                            <input type="number" class="form-control my-colorpicker1 required" id="amount" name="amount" placeholder="Enter amount">

                                        </div>
                                        <div class="form-group">
                                            <label>Balance :</label>
                                            <input type="number" class="form-control my-colorpicker1 required" id="balance" name="balance" placeholder="0.0">
                                        </div>
                                        <div class="form-group">
                                            <label>Shedule daily Payment:</label>
                                            <input type="number" class="form-control my-colorpicker1 required"  id="dpay" name="dpay" placeholder="daily payment">
