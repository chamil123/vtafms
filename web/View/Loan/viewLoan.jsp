...
<html>
    <head>
        ...
        <script>
            ...
            $(document).ready(function () {
                $("#searchs").autocomplete({source: Center, select: function (event, ui) {
    ...
    <body class="hold-transition skin-blue sidebar-mini" onload="load();">
        ...
        <%
            ...
            double rowCount = LoanController.getRowCount();
            ...
            List<Loan> listLoan = (List<Loan>) LoanController.limitresult("" + page1);

            String loanRes = request.getParameter("loanResult");
            int res_loan = 0;

            if (loanRes != null) {
                res_loan = Integer.parseInt(loanRes.toString());
            }
            ...
            if (name != null && pagenum != null) {
                ...
                Center center = CenterController.searchCenterByName(name);
                rowCount = LoanController.getRowCountSearch(center.getCenter_id());
                row = (int) rowCount;
                nopage = rowCount / 10;
                ...
                listLoan = (List<Loan>) LoanController.searchAndlimitResult(center.getCenter_id(), "" + page1);
            ...
            if (name == "") {
                ...
                rowCount = LoanController.getRowCount();
                row = (int) rowCount;
                nopage = rowCount / 10;
                ...
                listLoan = (List<Loan>) LoanController.limitresult("" + page1);
                ...
                <section class="content">
                    ...
                    <div class="box box-default">
                        <div class="col-md-12" style="height: 45px;padding-top: 8px">
                            ...
                            <form  class="form-inline" role="form"  action="../../AddLoan" method="POST" >

                                <div class="form-group">
                                    <a href="Loan.jsp" style="height: 28px;padding: 5px 10px 8px 10px;font-size: 12px;margin-left: -5px" class="btn btn-primary"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp; New Loan</a>
                                ...
                                <div class="form-group" style="float: right">
                                    ...
                                    <input style="height: 25px" type="text" class="form-control" name="searchs" id="searchs"  placeholder="Enter Center name">
                                    <button type="submit" class="btn btn-github"  style="height: 28px;padding: 5px 10px 8px 10px;font-size: 12px" value="search Loan" name="Search"><i class="glyphicon glyphicon-search" ></i>&nbsp;Search Loan</button>
                        ...
                        <table class="table table-striped" width="70%">
                            ...
                            <tr>
                                ...
                                <th>Remark&nbsp;</th>
                                <th>Balance&nbsp;</th>
                                <th>Sheddule payment&nbsp;</th>
                                <th>Amount&nbsp;</th>
                                <th>Actions&nbsp;</th>
                            </tr>
                            <%
                                Center center;
                                for (Loan model : listLoan) {
                                    center = CenterController.getAllCenterByID2(model.getCenter_id());
                            %>
                            <tr>
                                <td>&nbsp;<%=model.getLoan_id()%></td>
                                <td>&nbsp;<%=center.getCenter_Name()%></td>
                                <td>&nbsp;<%=model.getCenter_id()%></td>
                                <td><%=model.getLoan_dateRelease()%></td>
                                <td><%=model.getLoan_status()%></td>
                                <td><%=model.getLoan_remark()%></td>
                                <td><%=model.getLoan_balance()%></td>
                                <td><%=model.getLoan_scheduleOfPayment()%></td>
                                <td><%=model.getLoan_amount()%></td>
                                <td style="float: right;padding-right: 15px"> 

                                    <button type="submit" class="btn btn-warning btn-sm ">
                                        <a href="UpdateLoan.jsp?loan_id=<%=model.getLoan_id()%>&action=update"  style="color: white">
                                            <i class="glyphicon glyphicon-edit"></i>
                                        </a>
                                    </button>
                                    <button type="submit" class="btn btn-danger btn-sm ">
                                        <a href="#" onclick="getUserIdForDelete(<%=model.getLoan_id()%>);" style="color: white" data-toggle="modal" data-target="#deleteModal">
                        ...
                        <div class="pagination " style="width: 100%">
                            <% int i = 0;%>
                            <a href="viewLoan.jsp?page=<%=i%>" class="page active">first</a>
                            <% for (i = 1; i <= nopage; i++) {%>

                            <a href="viewLoan.jsp?page=<%=i%>" class="page">
                                <%=i%>
                            </a>
                            <% }%>
                            <a href="viewLoan.jsp?page=<%=i - 1%>" class="page active">last</a>
            ...
            <div class="modal fade" id="deleteModal" role="dialog" >
                <div class="modal-dialog" style="width: 500px">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="../../AddLoan?action=delete" method="POST">
                            ...
                            <div class="modal-footer" style="height: 48px;padding: 7px 7px 7px 17px;">
                                ...
                                <input type="hidden" class="form-control" id="iddelete"  name="loanid" >
                                <input  type="submit" class="btn btn-danger" value="Delete loan" name="delete" />
