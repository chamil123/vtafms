...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini" onload="selectedItem();">
        <%
            String timebag = request.getParameter("res_timebag");
            int res_timebag = 0;
            if (timebag != null) {
                res_timebag = Integer.parseInt(timebag.toString());
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>
                        Timebag
                        <small>Timbag registration</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Timebag</li>
                    </ol>
                </section>
                <section class="content">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <form method="POST" action="../../CollectTimeBags?action=add">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" style="width: 400px">
                                            ...
                                            <input type="hidden" name="rnum"  id="rnum" class="form-control">
                                            <input type="text" name="rname" style="color: black" id="rname" class="form-control" placeholder="Select Runner">
                                        </div>
                                        <div class="form-group" style="width: 400px">
                                            <label>date</label>
...
/////////////////////////////////////////////////////////
                                            ...
                                            Amount.type = "text";
                                            if (rowCount % 2 == 1) {
                                                Amount.style = "border-style: hidden;background-color : #EEEEEE;width:100px";
                                            } else {
                                                Amount.style = "border-style: hidden;width:100px";
                                            }
                                            Amount.name = "amount[" + counts + "]";
                                            Amount.id = "amount[" + (counts - 1) + "]";
                                            Amount.value = RateAmount;
                                            cell8.appendChild(Amount);
                                            ////////////////////////////////////////////////////////
                                    ...
                                    <div class="col-md-12" style="padding-left: 0px;padding-right: 0px">
                                        ...
                                        <div class="col-md-1" style="padding-right: 0px;;width: 130px">
                                        ...
                                        <div class="col-md-2"style="padding-left: 0px;padding-right: 0px;width: 115px">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-2"style="padding-left: 0px;padding-right: 0px;width: 155px">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" style="padding-top: 10px">
                                                ...
                                                <button type="submit" class="btn btn-primary"  value="Add timeBag"name="Add">
