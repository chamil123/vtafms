...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini" onload="selectedItem();">
        ...
        <%
            String exp = request.getParameter("res_expenses");
            int res_exp = 0;
            if (exp != null) {
                res_exp = Integer.parseInt(exp.toString());
            }
            System.out.print("res_exp ss s s sda : " + res_exp);
                    ...
                    <div class="row">
                        <form  role="form"  action="../../AddExpenses" method="POST" >
                            <div class="col-md-6">
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label>Date</label>
                                            <input type="text" class="form-control my-colorpicker1 required" id="date" name="date" placeholder="dd/mm/yyyy"/> 
                                        </div>
                                        <div class="form-group">

                                            <label>Payee</label>
                                            <input type="text" class="form-control my-colorpicker1 required"  id="payee" name="payee" placeholder="Enter payee">
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-primary" value="Add Expenses" name="Add"/>
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control required" rows="3" id="description" name="description" placeholder="Enter description"></textarea>
