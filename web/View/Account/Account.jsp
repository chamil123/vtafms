...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini" onload="load()">
        ...
        <%
            String account = request.getParameter("res_account");
            // Object runners=request.getAttribute("runnerResult");
            int res_account = 0;
            if (account != null) {
                res_account = Integer.parseInt(account.toString());
            }
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 required" onchange="maneFunction();" style="width: 100%;" id="accountcat" name="accountcat">
                                                ...
                                                %>
                                                <option value="<%=model.getAccount_category_id()%>" ><%=model.getAccount_category_name()%></option>
                                                <%}%>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text"  class="form-control my-colorpicker1" readonly id="acatnum"  name="acatnum" placeholder="Enter last name">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label>Description:</label>
                                                <textarea class="form-control" readonly rows="5" id="catdes" name="catdes" placeholder="Enter Address"></textarea>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control my-colorpicker1 required" id="acname" name="acname" placeholder="Enter mobile number">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control my-colorpicker1 required" id="stbalnce" name="stbalnce" value="0.0" placeholder="Enter home  number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label>Description</label>
                                                <textarea class="form-control required" rows="4" id="des" name="des" placeholder="Enter Description"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
